...
public final class ReferenceCatalog implements FraudDetector {
    ...
    private ReferenceCatalog(int n, short[][] dims, byte[] labels) {
        this.n = n;
        this.dims = dims;
        this.labels = labels;
    }
    ...
    private static final class Builder {
        ...
        ReferenceCatalog build() {
            ...
            return new ReferenceCatalog(n, dims, labels);
        }
    }
}
